...
$ Error = E_{y,L} 1(y \neq \varphi (x,L)) = P_{y,L} (y \neq \varphi (x,L))$

$ = P (y = 1) P(\varphi(x,L) = 0 ) + P(y =0) P(\varphi (x,L) =1 )$
...
<a href="https://i.imgur.com/Rml9Bi4"><img src="https://i.imgur.com/Rml9Bi4.jpg" width="300px" title="source: imgur.com" /></a>
